...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the email address of the administrator who is allowed to access
    | the Pulse dashboard. Set PULSE_ADMIN_EMAIL in your environment. If not
    | set, the dashboard will be inaccessible to all authenticated users.
    |
    */
